...
# typical than anything already in the reference document. Was left at the
# grounded-but-uncalibrated default of 1.0. A real 5-file threshold sweep, run
# after fixing Modules/base.py's sentence splitter to drop <4-word fragments
# (this checker's own docstring already notes it's especially exposed to
# unstable density estimates on short candidate sentences -- exactly what
# those fragments were), found threshold=0.5 gives F1=0.20 vs 0.10 at the old
# 1.0 default -- roughly double, and much closer to a real precision/recall
# balance (0.17/0.25 vs 0.06/0.42, i.e. 1.0 was flagging far too much).
THRESHOLD = 0.5
N_COMPONENTS = 5
